...
const JourneyTVView: React.FC<JourneyTVViewProps> = ({ user, onBack, language = 'en', spendPoints, onUnlockAchievement }) => {
  ...
  const handleOpenVideo = (video: VideoContent) => {
      ...
      // Unlock Achievement for watching
      if (onUnlockAchievement) {
          onUnlockAchievement('watcher');
      }
  };
