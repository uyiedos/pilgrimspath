...
const VoxelScene: React.FC<VoxelSceneProps> = ({ level, small = false, isCompleted = false }) => {
  ...
  const noiseFilter = `<filter id='n'><feTurbulence type='fractalNoise' baseFrequency='0.5' numOctaves='5' stitchTiles='stitch'/><feColorMatrix type='saturate' values='0'/></filter>`;
  
  // Rough Stone Texture for Walls - more definition
  const stoneTexture = `url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E${noiseFilter}%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.5'/%3E%3Crect width='100%25' height='100%25' fill='gray' opacity='0.2'/%3E%3Cpath d='M0 0 L100 0 L100 100 L0 100 Z' fill='none' stroke='rgba(0,0,0,0.3)' stroke-width='4'/%3E%3Cpath d='M10 10 L30 30 M70 20 L90 40 M20 80 L50 90 M60 60 L80 80' stroke='black' stroke-width='1' opacity='0.3'/%3E%3C/svg%3E")`;
  
  // Smooth Path Texture - cleaner
  const pathTexture = `url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E${noiseFilter}%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.1'/%3E%3Crect width='100%25' height='100%25' fill='white' opacity='0.05'/%3E%3Crect x='2' y='2' width='96' height='96' stroke='rgba(255,255,255,0.2)' stroke-width='2' fill='none'/%3E%3C/svg%3E")`;
  
  // Radiant Gold/Accent Texture - shinier
  const goldTexture = `url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E${noiseFilter}%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.2'/%3E%3Ccircle cx='50' cy='50' r='30' fill='url(%23g)' opacity='0.5'/%3E%3Cdefs%3E%3CradialGradient id='g'%3E%3Cstop offset='0%25' stop-color='white'/%3E%3Cstop offset='100%25' stop-color='gold' stop-opacity='0'/%3E%3C/radialGradient%3E%3C/defs%3E%3Crect x='5' y='5' width='90' height='90' stroke='gold' stroke-width='2' opacity='0.5'/%3E%3C/svg%3E")`;
