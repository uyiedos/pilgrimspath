                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {hasRequirement && !hasJoined && (
                                                <Button 
                                                    ...
                                                    className={`w-full py-3 text-[10px] uppercase font-retro shadow-lg border-2 ${requirementMet ? 'bg-gray-800 text-green-400 border-green-600' : 'bg-blue-900 text-white border-blue-500 animate-pulse'}`}
                                                >
                                                    {requirementMet ? `✓ ${raffle.action_label || 'Link Visited'}` : `🔗 ${raffle.action_label || 'Visit Sponsor'}`}
                                                </Button>
                                            )}
                                            ...
                                            <Button 
                                                ...
                                                className={`w-full py-3 shadow-lg ${hasJoined ? 'bg-gray-800 border-gray-600 text-gray-500' : !requirementMet ? 'bg-gray-800 border-gray-700 text-gray-500 cursor-not-allowed' : 'bg-green-700 hover:bg-green-600 border-green-400 animate-glow'}`}
                                            >
