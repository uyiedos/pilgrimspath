...
**Stack:** React, Vite, Supabase, Groq AI (Llama 3 70B)
...
#### ⚒️ Divine Economy
*   **Sacred Forge**: Use AI to manifest unique, tradable Artifacts (Avatars/Sanctuaries).
...
*   **Prayer Room**: Real-time voice interaction with the 'Eternal Guide'.
...
3.  **Groq API Key** (Llama 3 inference)
...
*   **AI**: `services/geminiService.ts` (Groq Implementation)
